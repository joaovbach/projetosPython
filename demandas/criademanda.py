...
import time
from mainData import dados
from mainData import valoresValidos
from mainData import manipulaBanco
...
def run(playwright, page):
    ...
    for i in range(0,3):
        ...
        external_ids.append(str(external))
    ...
    otimizar.run(playwright,page,external_ids)
